...
project = "pyscaffoldext-dsproject"
copyright = "2019, Florian Wilhelm"
...
try:
    from pyscaffoldext.dsproject import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = "pyscaffoldext-dsproject-doc"
...
latex_documents = [
    (
        "index",
        "user_guide.tex",
        "pyscaffoldext-dsproject Documentation",
        "Florian Wilhelm",
        "manual"
    )
]
